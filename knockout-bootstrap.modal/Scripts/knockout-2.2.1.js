...
(function() {
	...
	function j(w) { throw w; }

	var m = !0, p = null, r = !1;

	function u(w) { return function() { return w; }; }
	...
	function L(w) {
		...
		function ha(a, d, c, e, f) {
			...
			a = b.j(function() {
				...
				g.splice(0, g.length);
				b.a.P(g, a);
			}, p, { W: a, Ka: function() { return 0 == g.length || !b.a.X(g[0]); } });
			return { M: g, j: a.pa() ? a : I };
		}
		...
		function S(a, b, c, e, f) {
			var g = Math.min,
			    h = Math.max, k = [], l, n = a.length, q, s = b.length, v = s - n || 1, G = n + s + 1, J, A, z;
			for (l = 0; l <= n; l++) {
				A = J;
				k.push(J = []);
				z = g(s, l + v);
		...
		function T(a, d, c, e, f) {
			f = f || {};
			var g = a && N(a), g = g && g.ownerDocument, h = f.templateEngine || O;
			b.za.vb(c, h, g);
		...
		function N(a) { return a.nodeType ? a : 0 < a.length ? a[0] : p; }

		function U(a, d) {
			if (a.length) {
				var c = a[0], e = a[a.length - 1];
				V(c, e, function(a) { b.Da(d, a); });
				V(c, e, function(a) { b.s.ib(a, [d]); });
			}
		}
		...
		function X(a, d, c, e) {
			...
			function f(a) { return function() { return k[a]; }; }
		...
		function Y(a, d, c) {
			var e = m, f = 1 === d.nodeType;
			f && b.e.Ta(d);
			if (f && c || b.J.instance.nodeHasBindings(d)) e = X(d, p, a, c).Nb;
			e && Z(a, d, !f);
		}

		function Z(a, d, c) { for (var e = b.e.firstChild(d); d = e;) e = b.e.nextSibling(d), Y(a, d, c); }
		...
		function H(a) { return 8 == a.nodeType && (K ? a.text : a.nodeValue).match(ia); }

		function B(a) { return 8 == a.nodeType && (K ? a.text : a.nodeValue).match(ja); }

		function P(a, b) {
			for (var c = p; a != c;) c = a, a = a.replace(ka, function(a, c) { return b[c]; });
			return a;
		}
		...
		function Q(a, d, c, e) {
			b.c[a] = {
				init: function(a) {
					b.a.f.set(a, da, {});
					return { controlsDescendantBindings: m };
				},
		...
		b.a = new function() {
			...
			return {
				...
				bb: function(a, b) { 7 > n ? a.setAttribute("selected", b) : a.selected = b; },
				...
				X: function(a) { return b.a.tb(a, a.ownerDocument); },
				...
				n: function(b, d, c) {
					...
					if (!e && "undefined" != typeof F) {
						...
						!e && "function" == typeof b.addEventListener ? b.addEventListener(d, c, r) : "undefined" != typeof b.attachEvent ? b.attachEvent("on" +
				...
				Ba: function(b, d) {
					...
					if ("undefined" != typeof F) {
						var c = [];
						a(b, d) && c.push({ nb: b.checked });
						F(b).trigger(d, c);
					} else
						"function" == typeof y.createEvent ? "function" == typeof b.dispatchEvent ? (c = y.createEvent(e[d] || "HTMLEvents"), c.initEvent(d, m, m, x, 0, 0, 0, 0, 0, r, r, r, r, 0, b), b.dispatchEvent(c)) : j(Error("The supplied element doesn't support dispatchEvent")) :
				...
				ua: function(a) { return b.$(a) ? a.t() : a; },
				da: function(a, d, c) {
					if (d) {
				...
				wb: function(a) { 9 <= n && (a = 1 == a.nodeType ? a : a.parentNode, a.style && (a.style.zoom = a.style.zoom)); },
				ub: function(a) {
					if (9 <= n) {
						var b = a.style.width;
						a.style.width = 0;
				...
				Ib: function(a) { return "string" == typeof a && (a = b.a.D(a)) ? x.JSON && x.JSON.parse ? x.JSON.parse(a) : (new Function("return " + a))() : p; },
				xa: function(a, d, c) {
				...
				Jb: function(a, d, c) {
					c = c || {};
					var e = c.params || {}, f = c.includeFields || this.Na, g = a;
		...
		b.a.f = new function() {
			...
			return {
				...
				set: function(a, d, c) { c === I && b.a.f.la(a, r) === I || (b.a.f.la(a, m)[d] = c); },
				la: function(b, f) {
					var g = b[d];
					if (!g || !("null" !== g && c[g])) {
						if (!f) return I;
		...
		b.a.F = new function() {
			...
			var c = "__ko_domNodeDisposal__" + (new Date).getTime(), e = { 1: m, 8: m, 9: m }, f = { 1: m, 9: m };
			return {
				Ca: function(b, d) {
		...
		b.s = {
			...
			Ua: function(a) { return (a = a.match(/^\[ko_memo\:(.*?)\]$/)) ? a[1] : p; }
		};
		b.b("memoization", b.s);
		...
		b.S.fn = {
			ya: function(a, d, c) {
				c = c || "change";
				var e = new b.fb(this, d ? a.bind(d) : a, function() { b.a.ga(this.w[c], e); }.bind(this));
				this.w[c] || (this.w[c] = []);
				this.w[c].push(e);
				return e;
			},
			notifySubscribers: function(a, d) {
				d = d || "change";
				this.w[d] && b.r.K(function() { b.a.o(this.w[d].slice(0), function(b) { b && b.Cb !== m && b.ha(a); }); }, this);
			},
			yb: function() {
				var a = 0, b;
		...
		b.Qa = function(a) { return "function" == typeof a.ya && "function" == typeof a.notifySubscribers; };
		b.b("subscribable", b.S);
		b.b("isSubscribable", b.Qa);
		var C = [];
		b.r = {
			mb: function(a) { C.push({ ha: a, La: [] }); },
			end: function() { C.pop(); },
			Wa: function(a) {
		...
		var ma = { undefined: m, "boolean": m, number: m, string: m };
		b.m = function(a) {
		...
		b.m.fn[E] = b.m;
		b.ma = function(a, d) { return a === p || a === I || a[E] === I ? r : a[E] === d ? m : b.ma(a[E], d); };
		b.$ = function(a) { return b.ma(a, b.m); };
		b.Ra = function(a) { return "function" == typeof a && a[E] === b.m || "function" == typeof a && a[E] === b.j && a.zb ? m : r; };
		b.b("observable", b.m);
		b.b("isObservable", b.$);
		...
		b.R.fn = {
			...
			destroyAll: function(a) { return a === I ? this.destroy(u(m)) : !a ? [] : this.destroy(function(d) { return 0 <= b.a.i(a, d); }); },
			indexOf: function(a) {
				var d = this();
				return b.a.i(d, a);
			},
		...
		b.j = function(a, d, c) {
			...
			function g() {
				if (!q)
					if (n && w()) A();
						...
						q = m;
						try {
							var a = b.a.V(z, function(a) { return a.target; });
							b.r.mb(function(c) {
								var d;
			...
			function k() { return !n || 0 < z.length; }
			...
			if (G && k()) {
				...
				b.a.F.Ca(G, A);
				var D = w, w = function() { return !b.a.X(G) || D(); };
			}
			return h;
		};
		b.Bb = function(a) { return b.ma(a, b.j); };
		w = b.m.Kb;
		b.j[w] = b.m;
		b.j.fn = {};
		b.j.fn[w] = b.j;
		...
		b.e = {
			I: {},
			childNodes: function(a) { return B(a) ? aa(a) : a.childNodes; },
			Y: function(a) {
				if (B(a)) {
					a = b.e.childNodes(a);
			...
			Va: function(a, b) { B(a) ? a.parentNode.insertBefore(b, a.nextSibling) : a.firstChild ? a.insertBefore(b, a.firstChild) : a.appendChild(b); },
			Pa: function(a, d, c) {
				c ? B(a) ? a.parentNode.insertBefore(d,
					c.nextSibling) : c.nextSibling ? a.insertBefore(d, c.nextSibling) : a.appendChild(d) : b.e.Va(a, d);
			},
			firstChild: function(a) { return !B(a) ? a.firstChild : !a.nextSibling || H(a.nextSibling) ? p : a.nextSibling; },
			nextSibling: function(a) {
				B(a) && (a = $(a));
				return a.nextSibling && H(a.nextSibling) ? p : a.nextSibling;
			},
			jb: function(a) { return (a = B(a)) ? a[1] : p; },
			Ta: function(a) {
				if (pa[b.a.u(a)]) {
					var d = a.firstChild;
					if (d) {
		...
		b.a.extend(b.J.prototype, {
			...
			parseBindingsString: function(a, d, c) {
				try {
					var e;
					if (!(e = this.Ha[a])) {
						var f = this.Ha, g, h = "with($context){with($data||{}){return{" + b.g.ba(a) + "}}}";
		...
		b.Ea = function(a, b) { (1 === b.nodeType || 8 === b.nodeType) && Z(a, b, m); };
		b.Da = function(a, b) {
		...
		b.pb = function(a) { return (a = b.ja(a)) ? a.$data : I; };
		...
		b.b("contextFor", b.ja);
		b.b("dataFor", b.pb);
		var fa = { "class": "className", "for": "htmlFor" };
		b.c.attr = {
			update: function(a, d) {
				var c = b.a.d(d()) || {}, e;
				for (e in c)
					if ("string" == typeof e) {
						var f = b.a.d(c[e]), g = f === r || f === p || f === I;
		...
		b.c.foreach = {
			...
			init: function(a, d) { return b.c.template.init(a, b.c.foreach.Sa(d)); },
			update: function(a, d, c, e, f) { return b.c.template.update(a, b.c.foreach.Sa(d), c, e, f); }
		};
		b.g.Q.foreach = r;
		b.e.I.foreach = m;
		b.c.hasfocus = {
		...
		b.c.html = { init: function() { return { controlsDescendantBindings: m }; }, update: function(a, d) { b.a.ca(a, d()); } };
			...
			update: function(a, d, c) {
				...
				if (h) {
					...
					for (var n = h.length; d < n; d++) {
						var q = h[d];
						if (!q || !q._destroy || k) {
							var l = y.createElement("option"), s = function(a, b, c) {
								var d = typeof b;
		...
		b.c.text = { update: function(a, d) { b.a.cb(a, d()); } };
		b.e.I.text = m;
		b.c.uniqueName = {
			init: function(a, d) {
				if (d()) {
		...
		b.c.value = {
			init: function(a, d, c) {
				...
				var f = ["change"], g = c().valueUpdate, h = r;
				g && ("string" == typeof g && (g = [g]), b.a.P(f, g), f = b.a.Ga(f));
				if (b.a.Z && ("input" == a.tagName.toLowerCase() && "text" == a.type && "off" != a.autocomplete && (!a.form || "off" != a.form.autocomplete)) && -1 == b.a.i(f, "propertychange")) b.a.n(a, "propertychange", function() { h = m; }), b.a.n(a, "blur", function() { h && e(); });
				b.a.o(f, function(c) {
					var d = e;
		...
		b.v.prototype.renderTemplateSource =
			function() { j(Error("Override renderTemplateSource")); };
		b.v.prototype.createJavaScriptEvaluatorBlock = function() { j(Error("Override createJavaScriptEvaluatorBlock")); };
		...
		b.v.prototype.isTemplateRewritten = function(a, b) { return this.allowTemplateRewriting === r ? m : this.makeTemplateSource(a, b).data("isRewritten"); };
		...
		b.za = {
			vb: function(a,
				d, c) {
				d.isTemplateRewritten(a, c) || d.rewriteTemplate(a, function(a) { return b.za.Gb(a, d); }, c);
			},
			Gb: function(a, b) { return a.replace(qa, function(a, e, f, g, h, k, l) { return W(l, e, b); }).replace(ra, function(a, e) { return W(e, "\x3c!-- ko --\x3e", b); }); },
			kb: function(a) { return b.s.ra(function(d, c) { d.nextSibling && b.Fa(d.nextSibling, a, c); }); }
		};
		...
		b.l.O.prototype.text = function() {
			...
			b.a.f.set(this.h, "__ko_anon_template__", { Aa: arguments[0] });
		};
		...
		b.va = function(a, d, c, e, f) {
			...
			if (e) {
				...
				}, p, { Ka: function() { return !g || !b.a.X(g); }, W: g && "replaceNode" == f ? g.parentNode : g });
			}
			return b.s.ra(function(e) { b.va(a, d, c, e, "replaceNode"); });
		};
		b.Mb = function(a, d, c, e, f) {
			...
			return b.j(function() {
				...
				a = b.a.fa(a, function(a) { return c.includeDestroyed || a === I || a === p || !b.a.d(a._destroy); });
		...
		b.a.$a = function(a, d, c, e, f) {
			...
			d = d || [];
			e = e || {};
			var k = b.a.f.get(a, "setDomNodeChildrenFromArrayMapping_lastMappingResult") === I, l = b.a.f.get(a, "setDomNodeChildrenFromArrayMapping_lastMappingResult") || [], n = b.a.V(l, function(a) { return a.U; }), q = b.a.Ja(n, d), s = [], v = 0, w = 0, B = [], A = [];
			d = [];
			for (var z = [], n = [], t, D = 0, C, E; C = q[D]; D++)
		...
		b.qa = function() {
			...
			this.renderTemplateSource = function(b, c, e) {
				...
				b = [c.$data];
				c = F.extend({ koBindingContext: c }, e.templateOptions);
				c = F.tmpl(f, b, c);
			...
			this.addTemplate = function(a, b) { y.write("<script type='text/html' id='" + a + "'>" + b + "\x3c/script>"); };
